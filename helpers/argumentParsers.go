...
type BpfProgTypeArgument int32

const (
	BPF_PROG_TYPE_UNSPEC BpfProgTypeArgument = iota
...
func (p BpfProgTypeArgument) Value() uint64 { return uint64(p) }

var bpfProgTypeStringMap = map[BpfProgTypeArgument]string{
...
func (p BpfProgTypeArgument) String() string {
	var res string

	if sdName, ok := bpfProgTypeStringMap[p]; ok {
		res = sdName
	} else {
		res = strconv.Itoa(int(p))
	}
...
var bpfProgTypeMap = map[uint64]BpfProgTypeArgument{
	BPF_PROG_TYPE_UNSPEC.Value():                  BPF_PROG_TYPE_UNSPEC,
	BPF_PROG_TYPE_SOCKET_FILTER.Value():           BPF_PROG_TYPE_SOCKET_FILTER,
	BPF_PROG_TYPE_KPROBE.Value():                  BPF_PROG_TYPE_KPROBE,
	BPF_PROG_TYPE_SCHED_CLS.Value():               BPF_PROG_TYPE_SCHED_CLS,
	BPF_PROG_TYPE_SCHED_ACT.Value():               BPF_PROG_TYPE_SCHED_ACT,
	BPF_PROG_TYPE_TRACEPOINT.Value():              BPF_PROG_TYPE_TRACEPOINT,
	BPF_PROG_TYPE_XDP.Value():                     BPF_PROG_TYPE_XDP,
	BPF_PROG_TYPE_PERF_EVENT.Value():              BPF_PROG_TYPE_PERF_EVENT,
	BPF_PROG_TYPE_CGROUP_SKB.Value():              BPF_PROG_TYPE_CGROUP_SKB,
	BPF_PROG_TYPE_CGROUP_SOCK.Value():             BPF_PROG_TYPE_CGROUP_SOCK,
	BPF_PROG_TYPE_LWT_IN.Value():                  BPF_PROG_TYPE_LWT_IN,
	BPF_PROG_TYPE_LWT_OUT.Value():                 BPF_PROG_TYPE_LWT_OUT,
	BPF_PROG_TYPE_LWT_XMIT.Value():                BPF_PROG_TYPE_LWT_XMIT,
	BPF_PROG_TYPE_SOCK_OPS.Value():                BPF_PROG_TYPE_SOCK_OPS,
	BPF_PROG_TYPE_SK_SKB.Value():                  BPF_PROG_TYPE_SK_SKB,
	BPF_PROG_TYPE_CGROUP_DEVICE.Value():           BPF_PROG_TYPE_CGROUP_DEVICE,
	BPF_PROG_TYPE_SK_MSG.Value():                  BPF_PROG_TYPE_SK_MSG,
	BPF_PROG_TYPE_RAW_TRACEPOINT.Value():          BPF_PROG_TYPE_RAW_TRACEPOINT,
	BPF_PROG_TYPE_CGROUP_SOCK_ADDR.Value():        BPF_PROG_TYPE_CGROUP_SOCK_ADDR,
	BPF_PROG_TYPE_LWT_SEG6LOCAL.Value():           BPF_PROG_TYPE_LWT_SEG6LOCAL,
	BPF_PROG_TYPE_LIRC_MODE2.Value():              BPF_PROG_TYPE_LIRC_MODE2,
	BPF_PROG_TYPE_SK_REUSEPORT.Value():            BPF_PROG_TYPE_SK_REUSEPORT,
	BPF_PROG_TYPE_FLOW_DISSECTOR.Value():          BPF_PROG_TYPE_FLOW_DISSECTOR,
	BPF_PROG_TYPE_CGROUP_SYSCTL.Value():           BPF_PROG_TYPE_CGROUP_SYSCTL,
	BPF_PROG_TYPE_RAW_TRACEPOINT_WRITABLE.Value(): BPF_PROG_TYPE_RAW_TRACEPOINT_WRITABLE,
	BPF_PROG_TYPE_CGROUP_SOCKOPT.Value():          BPF_PROG_TYPE_CGROUP_SOCKOPT,
	BPF_PROG_TYPE_TRACING.Value():                 BPF_PROG_TYPE_TRACING,
	BPF_PROG_TYPE_STRUCT_OPS.Value():              BPF_PROG_TYPE_STRUCT_OPS,
	BPF_PROG_TYPE_EXT.Value():                     BPF_PROG_TYPE_EXT,
	BPF_PROG_TYPE_LSM.Value():                     BPF_PROG_TYPE_LSM,
	BPF_PROG_TYPE_SK_LOOKUP.Value():               BPF_PROG_TYPE_SK_LOOKUP,
	BPF_PROG_TYPE_SYSCALL.Value():                 BPF_PROG_TYPE_SYSCALL,
}

func ParseBpfProgTypeArgument(rawValue uint64) (BpfProgTypeArgument, error) {
